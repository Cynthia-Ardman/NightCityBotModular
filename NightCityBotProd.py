...
# --- Configuration ---
TOKEN = "MTIxMzI1MjEwNjA2NTAyMzAzNw.Gb-hkj.ph1aD23rSoYLxhj2J_-ovyzPXByL7Blq1efMGo"
...
async def collect_housing(ctx, user: discord.Member):
    ...
    RENT_LOG_CHANNEL_ID = 1379942446829404321
    EVICTION_CHANNEL_ID = 1379942591721902152
...
async def collect_rent(ctx, *, target_user: Optional[discord.Member] = None):
    ...
    eviction_channel = ctx.guild.get_channel(1379942446829404321)
    rent_log_channel = ctx.guild.get_channel(1379942591721902152)
...
async def test_open_shop_command(ctx):
    logs = []
    try:
        correct_channel_id = 1379941898772414464
